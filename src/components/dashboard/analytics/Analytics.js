...
const COLORS = ["#4B5563", "#D1D5DB", "#F3F4F6"];
        ...
        <>
            <div className="p-6 space-y-6 min-h-screen">
                <div className="flex justify-end">
                    <button className="flex items-center gap-2 bg-[#F3F4F6] text-black px-4 py-2 rounded">
                        <svg
                    ...
                    <div className="bg-white rounded-lg shadow p-6">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <div className="flex space-x-2">
                                <button className="px-3 py-1 text-xs rounded-full bg-gray-600 text-white">Year</button>
                ...
                <div className="bg-white border rounded-md shadow-sm p-6">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6">
                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            <button className="mt-4 bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded">
                                View Insights
                            </button>
                        </div>
                    </div>
